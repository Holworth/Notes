...
public class waterman_parallel {
   ...
   public static def fuckit(r:Long, scoreMatrix: Array_2[Long], input1:Rail[Char],input2:Rail[Char],blosum:Array_2[Long], current_position:Array_1[Long]): Long{
     if((r+1)<=input1.size)
     {
       async fuckit(r+1, scoreMatrix, input1, input2, blosum, current_position);
     }
  ...
  // var r:Long = 1;
    ...
    // Console.OUT.println(r);
      // async fuckit(r, scoreMatrix, input1, input2, blosum, current_position);		
      // r=r+1;
    // }
    finish fuckit(1, scoreMatrix, input1, input2, blosum, current_position);		
		return scoreMatrix;
   }
