...
public class waterman_parallel {
   ...
   public static def thread_task(r:Long, scoreMatrix: Array_2[Long], input1:Rail[Char],input2:Rail[Char],blosum:Array_2[Long], current_position:Array_1[Long], A:Long, B:Long): Long{
    if((r+1)<=input1.size)
    {
        async thread_task(r+1, scoreMatrix, input1, input2, blosum, current_position,A,B);
    }
...
public static def calculate(scoreMatrix: Array_2[Long], input1:Rail[Char],input2:Rail[Char],blosum:Array_2[Long],A:Long, B:Long): Array_2[Long]{
    ...
    // Console.OUT.println(r);
        ...
        // r=r+1;
    // }
    finish thread_task(1, scoreMatrix, input1, input2, blosum, current_position,A,B);        
    return scoreMatrix;
}
