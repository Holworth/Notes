...
public class waterman_parallel {
   ...
   val current_position = new Array_1[Long](input1.size,0);

	// for (var r:Long = 1;r<=input1.size;r++){
		// current_position(r)=0;
	// }

	finish for (var r:Long = 1;r<=input1.size;r++){
		async fuck(r, scoreMatrix, input1, input2, blosum, current_position);		
	}
		return scoreMatrix;
   }
